...
def classic_mode():
    # Вставь сюда свой основной код (или просто импортируй lab_missing_values.py, если он лежит отдельно)
    print("Режим обычного анализа без GUI")
    # ... (весь твой анализ тут, можешь даже просто сделать import lab_missing_values)
    pass

# ======= GUI PyQt5 =======
# ... импорт как у тебя выше (без изменений)
    ...
    class DataImputerGUI(QWidget):
        ...
        def load_dataset(self):
            ...
            try:
                ...
                # Добавляем все числовые + doctor
                for col in self.data.columns:
                    if pd.api.types.is_numeric_dtype(self.data[col]) or col == "doctor":
